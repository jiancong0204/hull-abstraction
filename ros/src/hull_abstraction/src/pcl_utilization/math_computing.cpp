...
bool pcl_utilization::isInside(std::vector<double> point, std::vector<std::vector<double>> polygon)
{
...
double pcl_utilization::calculateArea(std::vector<std::vector<double>> triangle)
{
...
std::vector<double> pcl_utilization::calculateNormal(std::vector<std::vector<double>> triangle)
{
    std::vector<double> vector1, vector2; // Two sides of the triangle
    for (int i = 0; i < 3; i++)
    {
...
std::vector<double> pcl_utilization::calculateCentralSymmetryPoint(std::vector<double> point, std::vector<double> center_point)
{
...
std::vector<double> pcl_utilization::calculatePerpendicularIntersection(std::vector<double> point1, std::vector<double> point2, std::vector<double> point3)
{
...
std::vector<double> pcl_utilization::uniformTriangleSampling(std::vector<std::vector<double>> triangle)
{
