...
namespace pcl_utils
{
     ...
     */
    sensor_msgs::PointCloud2::Ptr toROSMsgNormal(pcl::PointCloud<pcl::PointNormal>& cloud)
    {
        sensor_msgs::PointCloud2::Ptr msg(new sensor_msgs::PointCloud2);
        pcl::toROSMsg(cloud, *msg);
        return msg;
     ...
     */
    sensor_msgs::PointCloud2::Ptr toROSMsgRGBNormal(pcl::PointCloud<pcl::PointXYZRGBNormal>& cloud)
    {
        sensor_msgs::PointCloud2::Ptr msg(new sensor_msgs::PointCloud2);
        pcl::toROSMsg(cloud, *msg);
        return msg;
