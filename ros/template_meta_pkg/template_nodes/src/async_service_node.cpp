/**
 * @file
 * @brief The entry point for the async_service node
 *
 * @author Henrik Stickann
 */

#include "async_service_node/async_service.h"
...
int main(int argc, char ** argv)
{
    ...
    ros::init(argc, argv, "async_service");

    try {
        // Instantiate object and run node logic
        template_nodes::AsyncService node_impl;
