/**
 * @file
 * @brief The entry point for the do_something_action node
 *
 * @author Henrik Stickann
 */

#include "do_something_action_node/do_something_action.h"
...
int main(int argc, char ** argv)
{
    ...
    ros::init(argc, argv, "do_something_action");

    try {
        // Instantiate object and run node logic
        template_nodes::DoSomethingAction node_impl;
