...
int main()
{
    ...
    // Down sampling
    //start = clock();
    //pp.statisticalFilter(cloud, cloudFiltered);
    //end = clock();
    ...
    //Normal estimation
    start = clock();
    pp.appendNormalEstimation(cloud, cloudWithNormals);
    end = clock();
    ...
    start = clock();
    mesh2 = rc.bsplineSurfaceFitting(cloudFiltered);
    end = clock();
    ...
    viewer->addPointCloud(cloudFiltered, "cloud2", v2);
